...
export const actionFetchApprovalData = async (
  payload = {},
  next = (f) => f
) => {
...
export const actionFetchDataById = async (
  id,
  payload = {},
  next = (f) => f
) => {
...
export const actionSearchData = async (
  query,
  payload = {},
  next = (f) => f
) => {
...
export function setLink(value) {
  return { type: "DATA_LINK", payload: value };
}
